...
public class ScheduledFlightController {
    ...
    @PostMapping("/searchByAirportAndDate")
    public List<scheduledFlight> searchScheduledFightByAirportAndDate(@Valid @RequestBody List<airport> airport){
        return scheduledFlightDao.viewScheduledFlights(airport.get(0),airport.get(1));
    }
